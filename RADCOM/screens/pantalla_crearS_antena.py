...
from screens.pantalla_crearS_antena_ui import Ui_Form  # Importa la clase generada por Qt Designer
import sys
...
if __name__ == "__main__":
    ...
    window = PantallaCrearSAntena()  # Cambiar a la clase correcta
    window.show()
    sys.exit(app.exec_())
