...
from screens.pantalla_factura_facturador_ui import Ui_Form  # Importa la clase generada por Qt Designer
import sys
...
if __name__ == "__main__":
    ...
    window = PantallaFacturaFacturador()  # Cambiar a la clase correcta
    window.show()
    sys.exit(app.exec_())
